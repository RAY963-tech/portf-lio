...
async function getAboutGithub() {
  try {
    ...
    const resposta = await fetch('https://api.github.com/users/RAY963-tech');
    ...
    about.innerHTML = `
      ...
      <article class="about-content">
        <h2>Sobre mim</h2>
        <p>
          Profissional da área de tecnologia, com interesse em desenvolvimento e foco em crescimento
          contínuo. Atua com dedicação, organização e atenção aos detalhes, buscando sempre
          evoluir tecnicamente e entregar soluções bem estruturadas.
        </p>
        
        <p>
          Possui facilidade para aprender, se adaptar a novos desafios e trabalhar com
          responsabilidade. Tem como objetivo consolidar sua carreira na área tech, contribuindo
          de forma positiva em projetos e equipes.
        </p>
...
async function getProjectsGithub() {
  try {
    ...
    repositorios.forEach((repositorio) => {
      ...
      const config = linguagens[linguagemExibir] || { icone: 'github' };
